...
export const SKILL_REGISTRY: SkillDefinition[] = [
  ...
  },
  {
    ...
    primaryDomainId: "programming-languages",
    secondaryDomainIds: ["ai-ml", "data-science"],
    curriculum: [
      {
        domain: "Syntax & Types",
        topics: [
  ...
  },
  {
    ...
    primaryDomainId: "programming-languages",
    secondaryDomainIds: ["computer-science", "game-development", "embedded-iot"],
    curriculum: [
      {
  ...
  },
  {
    ...
    primaryDomainId: "computer-science",
    secondaryDomainIds: ["programming-languages", "embedded-iot"],
    curriculum: [
      {
        domain: "Core Syntax",
        topics: [
  ...
  },
  {
    ...
    primaryDomainId: "programming-languages",
    secondaryDomainIds: ["game-development"],
    curriculum: [
      {
        domain: "Core Language",
        topics: [
  ...
  },
  {
    ...
    primaryDomainId: "programming-languages",
    secondaryDomainIds: ["computer-science"],
    curriculum: [
      {
  ...
  },
  {
    ...
    primaryDomainId: "mobile-development",
    curriculum: [
      {
        domain: "Swift Core",
        topics: [
  ...
  },
  {
    ...
    primaryDomainId: "api-development",
    secondaryDomainIds: [],
    curriculum: [
      {
  ...
  },
  {
    ...
    primaryDomainId: "databases",
    secondaryDomainIds: ["data-engineering", "data-science"],
    curriculum: [
      {
  ...
  },
  {
    ...
    primaryDomainId: "databases",
    secondaryDomainIds: ["data-engineering"],
    curriculum: [
      {
        domain: "Architecture",
        topics: [
  ...
  },
  {
    ...
    primaryDomainId: "data-engineering",
    secondaryDomainIds: [],
    curriculum: [
      {
        domain: "Architecture",
  ...
  },
  {
    ...
    primaryDomainId: "data-engineering",
    secondaryDomainIds: ["data-science"],
    curriculum: [
      {
        domain: "Core Architecture",
        topics: [
  ...
  },
  {
    ...
    primaryDomainId: "computer-science",
    secondaryDomainIds: ["devops-cloud"],
    curriculum: [
      {
  ...
  },
  {
    ...
    primaryDomainId: "blockchain-web3",
    curriculum: [
      {
        domain: "Core Architecture",
        topics: [
  ...
  },
  {
    ...
    primaryDomainId: "game-development",
    curriculum: [
      {
        domain: "Architecture",
        topics: [
...
export const PATHWAY_REGISTRY: import('../types').PathwayDefinition[] = [
  ...
  { id: 'mobile-development', name: 'Mobile Development', description: 'iOS, Android, and cross-platform app development.', aliases: ['mobile'] },
  { id: 'api-development', name: 'API Development', description: 'API design, REST, GraphQL, and microservices communication.', aliases: ['api', 'apis'] },
  { id: 'data-engineering', name: 'Data Engineering', description: 'Data pipelines, streaming, and big data orchestration.', aliases: ['data engineering'] },
  { id: 'system-design', name: 'System Design & Architecture', description: 'High-level architecture, scalability, and design patterns.', aliases: ['system design', 'architecture'] },
  { id: 'networking', name: 'Networking', description: 'Network topologies, protocols, and routing.', aliases: ['networks'] },
  { id: 'data-science', name: 'Data Science', description: 'Data analysis, statistics, and scientific computing.', aliases: ['data science'] },
  { id: 'testing-qa', name: 'Testing & QA', description: 'Software testing, test automation, and quality assurance.', aliases: ['testing', 'qa'] },
  { id: 'blockchain-web3', name: 'Blockchain & Web3', description: 'Decentralized ledgers, smart contracts, and Web3.', aliases: ['blockchain', 'web3'] },
  { id: 'game-development', name: 'Game Development', description: 'Game engines, rendering, and game loops.', aliases: ['gamedev'] },
  { id: 'embedded-iot', name: 'Embedded Systems & IoT', description: 'Bare-metal programming, hardware, and sensors.', aliases: ['embedded', 'iot'] },
  { id: 'ui-ux-design', name: 'UI/UX Design', description: 'User interface and experience design.', aliases: ['ui', 'ux', 'design'] }
];

export const getSkillsForPathway = (pathwayId: string): SkillDefinition[] => {
  return SKILL_REGISTRY.filter(
    (skill) =>
      skill.primaryDomainId === pathwayId ||
      (skill.secondaryDomainIds && skill.secondaryDomainIds.includes(pathwayId))
  );
};

...
export function loadInitialState() {
  return {
    ...
    settings: loadProgression<Settings>({ animationIntensity: 'high', reducedMotion: false, soundEffects: false, theme: 'light', streakTracking: true, onboarded: false }, 'settings'),
...
export function getEmptyState() {
  return {
    ...
    badges: [] as Badge[],
    settings: { animationIntensity: 'high', reducedMotion: false, soundEffects: false, theme: 'light', streakTracking: true, onboarded: false } as Settings,

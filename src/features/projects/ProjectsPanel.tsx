            ...
            >
              ...
              <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                ...
                <div style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap' }}>
                  {(Array.isArray(p.technologies) ? p.technologies : []).slice(0, 3).map((tech) => (
      ...
      {activeProject && (
        <div className="panel" style={{ padding: '2rem', background: 'rgba(3,4,7,0.7)', border: '1px solid rgba(255,255,255,0.08)' }}>
          ...
          <div style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap', marginBottom: '2rem' }}>
            {(Array.isArray(activeProject.technologies) ? activeProject.technologies : []).map((tech) => (
          ...
          <div style={{ marginBottom: '2rem' }}>
            ...
            <ul style={{ margin: 0, padding: 0, listStyle: 'none', display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
              {(Array.isArray(activeProject.features) ? activeProject.features : []).map((feature) => (
          ...
          <div style={{ marginBottom: '3rem' }}>
            ...
            <ul style={{ margin: 0, padding: 0, listStyle: 'none', display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
              {(Array.isArray(activeProject.whatILearned) ? activeProject.whatILearned : []).map((item) => (

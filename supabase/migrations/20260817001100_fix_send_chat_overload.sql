-- ============================================================
-- DROP ALL EXISTING OVERLOADS OF send_chat_message
-- AND CREATE A SINGLE DEFINITIVE VERSION
-- ============================================================
...
GRANT EXECUTE ON FUNCTION public.send_chat_message(text, text, text, text) TO authenticated;
